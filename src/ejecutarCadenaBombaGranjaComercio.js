...
function ejecutarCadenaBombaGranjaComercio(numTicks) {
  ...
  for (let tick = 0; tick < numTicks; tick += 1) {
    ...
    const cantidadDisponibleParaVenta = almacenGranja.stockProducto;
    const manzanasCompradas = resolverCompraAlmacen(cantidadDisponibleParaVenta, CAPACIDAD_COMPRA_COMERCIO);
...
module.exports = { ejecutarCadenaBombaGranjaComercio };