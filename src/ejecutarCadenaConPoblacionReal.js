...
function ejecutarCadenaConPoblacionReal() {
  ...
  colocarNodo(grid, 0, 1, 'no_extractiva', 'casa-1');
  ...
  // b. POBLACION Y AGUA
  const poblacionInicial = poblacionTotalCasas([10]);
  ...
  const aguaRecibidaGranja = resultadoViaje.entregado;
  ...
  // e. MANZANAS RESTANTES AL COMERCIO
...
module.exports = { ejecutarCadenaConPoblacionReal };
